        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 form-group"> 
                        ...
                        <div class="row" style="margin-top:10px!important">
                        <div id="pie-chartdiv" class="col-12"></div>
                            <div id="bar-chartdiv" class="col-12"></div>
                            <div id="d3bar-chartdiv" class="col-12"></div>
                            <div id="donut-chartdiv" class="col-12"></div>
                            <div id="horizontal-chartdiv" class="col-12"></div>
                            <div id="line-chartdiv" class="col-12"></div>
                            <div id="radar-chartdiv" class="col-12"></div>
                            <div id="radar1-chartdiv" class="col-12"></div>
                            <div id="polar-chartdiv" class="col-12"></div>
                            <div id="bubble-chartdiv" class="col-12"></div>
                            <div id="no_table_chart" class="col-12"><table class="table table-striped table-bordered table-sm"></table></div>
                            <div id="responsive_table" class="col-12 table-responsive-sm"><table class="table table-striped table-bordered table-sm"></table></div>
                            <div id="sortable_table" class="col-12"><table class="table table-striped table-bordered table-sm"></table></div>                            
                            <div id="table_result" class="col-12">
                            </div>
                            <div class="col-12" id="newChartArea">
