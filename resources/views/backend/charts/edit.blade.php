                ...
                <div class="col-12 form-group"> 
                        ...
                        <div class="row" style="margin-top:10px!important">
                            ...
                            <div id="option-tablediv" class="col-2">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <input type="number" value="0" id="th-size" class="form-control" style="width:100%;">
                                        <label>Header Color:</label>
                                        <input type="color" id="th-fcolor" class="form-control" style="width:100%;">
                                        <label>Header backgroundColor:</label>
                                        <input type="color" id="th-bcolor" class="form-control" style="width:100%;">
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <label>Body FontSize:</label>
                                        <input type="number" id="tb-size" value="0" class="form-control" style="width:100%;">
                            ...
                            <div id="sortable_table" class="col-8 custom">
                                <table class="table table-striped table-bordered table-sm" cellspacing="0" width="100%"></table>
                            </div>                            
